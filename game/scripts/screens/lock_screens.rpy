init python:
    ...
    def attempt_lockpick(lock_obj):
        skill = player.get_stat_total("dexterity")
    ...
    def attempt_hack(lock_obj):
        skill = player.get_stat_total("intelligence")
        target = lock_obj.difficulty * 3 + 5
    ...
    frame:
        ...
        vbox:
            ...
            grid 2 2:
                ...
                # 2. Pick Lock
                $ pick_skill = player.get_stat_total("dexterity")
                ...
                # 3. Hack
                $ hack_skill = player.get_stat_total("intelligence")
