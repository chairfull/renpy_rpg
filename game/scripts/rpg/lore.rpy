init python:
    class LoreCategory:
        def __init__(self, _id, name, tags=None):
            self.id = _id
            self.name = name
...
# default unlocked_notes = set()
# default persistent.note_manager = NoteManager()

# init 10 python:
#     onstart(add_meta_menu_tab, "notes", "📘", "Journal",
#         selected_tab="notes",
#         selected_note=None)
...
#                     signal("NOTE_UNLOCKED", note=note_id)
