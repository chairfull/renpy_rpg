...
label CHAR__theo: # @data/characters/theo.md:47
    theo "If we can chart the pattern decay of the Spire, we can predict when the next drift will peak." # @data/characters/theo.md:47
    theo "History isn't just about what we lost; it's about the frequencies we forgot how to tune into." # @data/characters/theo.md:48
    $ theo.mark_as_met() # @data/characters/theo.md:49
    return # @data/characters/theo.md:49

label CHAR__theo__talk: # @data/characters/theo.md:47
    theo "If we can chart the pattern decay of the Spire, we can predict when the next drift will peak." # @data/characters/theo.md:47
    theo "History isn't just about what we lost; it's about the frequencies we forgot how to tune into." # @data/characters/theo.md:48
    $ theo.mark_as_met() # @data/characters/theo.md:49
    return # @data/characters/theo.md:49
...
label CHAR__kael__dialogue__ask_about_breaching: # @data/characters/kael.md:67
    kael "You don't clear them all. You find the resonance point, hit it hard, and run through the gap before they reset." # @data/characters/kael.md:67
    kael "It's about timing and weight. Stay heavy, move fast." # @data/characters/kael.md:68
    return # @data/characters/kael.md:68
...
label ITEM__apple__flow: # @data/items/apple.md:16
    $ renpy.call('show_item', 'apple') # @data/items/apple.md:16
    "Sealed, sweet, and a little chalky." # @data/items/apple.md:17
    "It keeps you moving." # @data/items/apple.md:18
    $ renpy.call('hide_item', 'apple') # @data/items/apple.md:19
    return # @data/items/apple.md:19

label ITEM__apple__inspect: # @data/items/apple.md:16
    $ renpy.call('show_item', 'apple') # @data/items/apple.md:16
    "Sealed, sweet, and a little chalky." # @data/items/apple.md:17
    "It keeps you moving." # @data/items/apple.md:18
    $ renpy.call('hide_item', 'apple') # @data/items/apple.md:19
...
label ITEM__potion__flow: # @data/items/potion.md:17
    "Clear liquid, faint alcohol smell, and a sterile snap when opened." # @data/items/potion.md:17
    return # @data/items/potion.md:17

label ITEM__potion__inspect: # @data/items/potion.md:17
    "Clear liquid, faint alcohol smell, and a sterile snap when opened." # @data/items/potion.md:17
    return # @data/items/potion.md:17

label ITEM__sword__flow: # @data/items/sword.md:18
    "Scuffed steel, a wrapped grip, and a few old paint flecks." # @data/items/sword.md:18
    "It is built to endure." # @data/items/sword.md:19
    return # @data/items/sword.md:19

label ITEM__sword__inspect: # @data/items/sword.md:18
    "Scuffed steel, a wrapped grip, and a few old paint flecks." # @data/items/sword.md:18
    "It is built to endure." # @data/items/sword.md:19
    return # @data/items/sword.md:19
...
label QUEST__apple_hunt__goals__visit_the_supply_depot: # @data/quests/apple_hunt.md:18
    "This is the depot. If any rations remain, they will be here." # @data/quests/apple_hunt.md:18
    return # @data/quests/apple_hunt.md:18

label QUEST__apple_hunt__goals__collect_rations: # @data/quests/apple_hunt.md:23
    "That should be enough for today." # @data/quests/apple_hunt.md:23
