...
init python:
    def _cond_8813590301138068710(): return not flag_get('scout_joined', False)
    def _cond__9107689649914868147(): return flag_get('scout_joined', False)
    def _cond_1(): return True
    def _cond__9129185675251791746(): return flag_get('protocol_recovered', False) and not flag_get('protocol_deciphered', False)
    def _cond_7027215552206075494(): return character.stats.charisma >= 10
    def _cond_1702453642866147531(): return not flag_get('cadence_learned', False)
    def _cond_5040495432051422037(): return theo.bond(ash, "affinity") > 10
    def _cond__1754469113350881451(): return flag_get("harmonic_key_obtained")
...
default theo = RPGCharacter("theo", name='Theo', desc='Dedicated to preserving pre-fall data logs and charting the decay of the global transmission grid.', base_image='chars/male_thin.png', location='temple', pos=[500, 0, 500], stats={'strength': 8, 'dexterity': 10, 'intelligence': 16, 'charisma': 14}, tags=['archivist', 'lore', 'researcher'], gender='male', age=27, height='172 cm', weight='60 kg', hair_color='dark brown', hair_style='messy', eye_color='green', face_shape='oval', skin_tone='light', build='slim', body_type='humanoid', breast_size='n/a', dick_size='average', foot_size=41, distinctive_feature='ink-smudged collar', equipment={'head': 'knit_cap', 'torso': 'archivist_coat', 'pants': 'slacks', 'feet': 'sneakers'}, items=['ration_bar', 'note_card', 'map_fragment', 'radio_receiver', 'battery_cell'])
...
default shop__back_room = Zone(desc='Shelves are here.')
...
default broadcast_tower__lobby = Zone(name='Broadcast Tower Lobby', desc='Dusty consoles and a sealed control room.', zone_type='floor', position=[1200, 0, 800], zoom_range=[3.0, 5.0], floor=1, entities=[{'id': 'signal_console', 'type': 'object', 'name': 'Signal Console', 'desc': 'A flickering screen covered in grime. It hums with a steady rhythm.', 'label': 'console_interaction', 'x': 800, 'y': 400, 'sprite': 'images/topdown/chars/male_base.png'}])
...
default safehouse__attic = Zone(name='Attic', desc='A cramped attic full of stored crates and old insulation.', zone_type='floor', floor=3)
default safehouse__top_floor = Zone(name='Top Floor', desc='Quiet sleeping quarters and the bathroom.', zone_type='floor', floor=2)
default safehouse__main_bedroom = Zone(desc='Your assigned room with a narrow cot and a small mirror.', zone_type='room', entities=[{'id': 'bed', 'type': 'object', 'name': 'Cot', 'desc': 'A narrow cot with a clean blanket.', 'x': 300, 'y': 500, 'sprite': 'images/topdown/chars/male_base.png'}, {'id': 'mirror', 'type': 'object', 'name': 'Small Mirror', 'desc': 'Check your face and move on.', 'x': 1400, 'y': 300, 'sprite': 'images/topdown/chars/male_base.png'}, {'id': 'closet', 'type': 'container', 'name': 'Supply Locker', 'desc': 'A battered locker for your essentials.', 'x': 0, 'y': 0, 'items': ['camp_kit', 'ration_bar', 'antiseptic_ampoule'], 'sprite': 'images/topdown/chars/male_base.png'}])
default safehouse__guest_bedroom = Zone(desc='A spare room kept ready for visitors or injured runners.', zone_type='room')
default safehouse__kids_bedroom = Zone(desc='A small room with mismatched blankets and hand-drawn maps.', zone_type='room')
default safehouse__bathroom = Zone(desc='A compact washroom with a trickling filter line.', zone_type='room')
default safehouse__main_floor = Zone(name='Main Floor', desc='The day-to-day living space, with work areas and a garage.', zone_type='floor', floor=1)
default safehouse__garage = Zone(desc='A converted bay for carts, tools, and quiet repairs.', zone_type='room')
default safehouse__kitchen = Zone(desc='A narrow galley for ration prep and shared meals.', zone_type='room')
default safehouse__living_room = Zone(desc='A low-lit common area with patched couches and old screens.', zone_type='room')
default safehouse__office = Zone(desc='A cramped desk space for logs, maps, and comms.', zone_type='room')
default safehouse__basement = Zone(name='Basement', desc='Utility space with old ducting and supply cages.', zone_type='floor', floor=0)
default safehouse__furnace_room = Zone(desc='The heat hub, lined with filters and rumbling vents.', zone_type='room')
default safehouse__supply_room = Zone(desc='Locked shelves of spare parts and emergency stocks.', zone_type='room')
# All zones.
define all_zones = {
    "shop": shop,
    "civic_hub": civic_hub,
...
default silent_tide__ordinary_world = Goal(desc='Look for the $clerk at the $shop.', hilight={'locations': ['shop'], 'objects': ['clerk']}, trigger={'event': 'CHAR_MET', 'state': {'character': 'clerk'}})
default silent_tide__call_to_adventure = Goal(desc='Check out the $market.', hilight={'locations': ['market']}, trigger={'event': 'LOCATION_ENTERED', 'state': {'location': 'market'}})
default silent_tide__refusal_of_the_call = Goal(desc='Visit the $clerk at the $shop.', hilight={'locations': ['shop']}, trigger={'event': 'LOCATION_ENTERED', 'state': {'character': 'theo', 'location': 'shop'}})
default silent_tide__meeting_the_mentor = Goal(desc='Talk to $ash at the $tavern.', hilight={'locations': ['tavern'], 'objects': ['ash']}, trigger={'event': 'CHAR_MET', 'state': {'a': 'theo', 'b': 'ash'}})
default silent_tide__crossing_the_threshold = Goal(desk='Visit the docks.', hiligh={'locations': ['docks']}, trigger={'event': 'LOCATION_ENTERED', 'state': {'character': 'theo', 'location': 'docks'}})
default silent_tide__tests_and_allies = Goal(hilight={'locations': ['tavern']}, trigger={'event': 'LOCATION_ENTERED', 'state': {'character': 'theo', 'location': 'tavern'}})
default silent_tide__approach = Goal(hilight={'locations': ['mage_tower']}, trigger={'event': 'LOCATION_ENTERED', 'state': {'character': 'theo', 'location': 'mage_tower'}})
default silent_tide__ordeal = Goal(desc='Visit the $mage_tower.', hilight={'locations': ['mage_tower']}, trigger={'event': 'LOCATION_ENTERED', 'state': {'character': 'theo', 'location': 'mage_tower'}, 'flags': {'broadcast_tower_reached': True}})
default silent_tide__reward = Goal(name='Find the Harmonic Key', trigger={'event': 'FLAG_SET', 'flags': {'harmonic_key_obtained': True}})
default silent_tide__the_road_back = Goal(desc='Head back to temple.', hilight={'locations': ['temple']}, trigger={'event': 'LOCATION_ENTERED', 'state': {'character': 'theo', 'location': 'temple'}})
default silent_tide__resurrection = Goal(desc='Visit the market.', hiligh={'locations': ['market']}, trigger={'event': 'LOCATION_ENTERED', 'state': {'character': 'theo', 'location': 'market'}, 'flags': {'broadcast_success': True}})
default silent_tide__return_with_the_elixir = Goal(hilight={'location': 'temple'}, trigger={'event': 'LOCATION_ENTERED', 'state': {'character': 'theo', 'location': 'temple'}})
default silent_tide__ask_the_clerk = Choice(menu='clerk', id='ask_clerk', text="Ask the clerk about the sleepers' rhythm.", flags={'asked_clerk': None})
default silent_tide__share_the_pattern_with_ash = Choice(menu='ash', id='share_with_ash', text="Share the pattern you've recorded with Ash.", cond='5040495432051422037')
default silent_tide__attempt_harmonic_broadcast = Choice(menu='clerk', id='attempt_broadcast', text='Offer to run the harmonic broadcast (requires harmonic key).', cond='_1754469113350881451')
# All quests.
define all_quests = {
...
# --- ITEM_SLOT x8 ---
# Main Hand. 
default main_hand = ItemSlot("main_hand", name='Main Hand', unequips=['left_hand', 'right_hand'])
# Torso. 
default torso = ItemSlot("torso", name='Torso', unequips=['two_piece'])
# Full Body Outfit. 
default full_body_outfit = ItemSlot("full_body_outfit", name='Full Body Outfit', unequips=['torso', 'pants'])
# Right Hand. 
default right_hand = ItemSlot("right_hand", name='Right Hand', unequips=['main_hand'])
# Left Hand. 
default left_hand = ItemSlot("left_hand", name='Left Hand', unequips=['main_hand'])
# Body. 
default body = ItemSlot("body", name='Body')
# Pants. 
default pants = ItemSlot("pants", name='Pants', unequips=['two_piece'])
# Head. 
default head = ItemSlot("head", name='Head')
# All item_slots.
define all_item_slots = {
    "main_hand": main_hand,
    "torso": torso,
...
# --- ITEM_SLOT_SET x2 ---
# Humanoid. 
default humanoid = ItemSlotSet("humanoid", name='Humanoid', slots=['head', 'torso', 'pants', 'main_hand', 'left_hand', 'right_hand', 'two_piece', 'feet'])
# Quadruped. 
default quadruped = ItemSlotSet("quadruped", name='Quadruped', slots=['head', 'body', 'saddle'])
# All item_slot_sets.
define all_item_slot_sets = {
    "humanoid": humanoid,
    "quadruped": quadruped,
}
...
# Body. 
default body = Trait("body", name='Body', tags=['body'], keys={'build': {'options': ['skinny', 'average', 'big']}, 'height': {'range': [0, 100]}, 'weight': {'range': [0, 100]}})
# Age. 
...
label quest:
    ...
    label .silent_tide:
        label .started:
            ...
            $ call_flow_action("GOAL_SHOW", silent-tide#ordinary-world)
            return
        label .ordinary_world:
            ...
            $ call_flow_action("GOAL_TICK", silent-tide#ordinary-world)
            $ call_flow_action("GOAL_SHOW", silent-tide#call-to-adventure)
            return
        label .call_to_adventure:
            ...
            $ call_flow_action("GOAL_TICK", silent-tide#call-to-adventure)
            $ call_flow_action("GOAL_SHOW", silent-tide#refusal-of-the-call)
            return
        label .refusal_of_the_call:
            ...
            $ call_flow_action("GOAL_TICK", silent-tide#refusal-of-the-call)
            $ call_flow_action("GOAL_SHOW", silent-tide#meeting-the-mentor)
            return
        label .meeting_the_mentor:
            $ call_flow_action("GOAL_TICK", silent-tide#meeting-the-mentor)
            ...
            $ call_flow_action("GOAL_SHOW", silent-tide#crossing-the-threshold)
            return
        label .crossing_the_threshold:
            $ call_flow_action("GOAL_TICK", silent-tide#crossing-the-threshold)
            ...
            $ call_flow_action("GOAL_SHOW", silent-tide#tests_and_allies)
            return
        label .tests_and_allies:
            $ call_flow_action("GOAL_TICK", silent-tide#tests_and_allies)
            ...
            $ call_flow_action("GOAL_SHOW", silent-tide#approach)
            return
        label .approach:
            $ call_flow_action("GOAL_TICK", silent-tide#approach)
            ...
            $ call_flow_action("GOAL_TICK", silent-tide#ordeal)
            return
        label .ordeal:
            $ call_flow_action("GOAL_TICK", silent-tide#ordeal)
            ...
            $ call_flow_action("GOAL_SHOW", silent-tide#reward)
            return
        label .reward:
            $ call_flow_action("GOAL_TICK", silent-tide#reward)
            ...
            $ call_flow_action("GOAL_SHOW", silent-tide#the-road-back)
            return
        label .the_road_back:
            $ call_flow_action("GOAL_TICK", silent-tide#the-road-back)
            ...
            $ call_flow_action("GOAL_SHOW", silent-tide#resurrection)
            return
        label .resurrection:
            $ call_flow_action("GOAL_SHOW", silent-tide#resurrection)
            ...
            $ call_flow_action("GOAL_SHOW", silent-tide#return-with-the-elixer)
            return
        label .return_with_the_elixir:
            $ call_flow_action("GOAL_TICK", silent-tide#return-with-the-elixir)
            ...
            $ call_flow_action("GOAL_PASSED", silent-tide)
            return
        label .passed:
